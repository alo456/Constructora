...
class Recurso
{
     ...
     * Add orden.
     *
     * @param \App\Entity\RecursosPorOrden $orden
     *
     * @return Recurso
     */
    public function addOrden(\App\Entity\RecursosPorOrden $orden)
    {
        $this->orden[] = $orden;
     ...
     * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
     */
    public function removeOrden(\App\Entity\RecursosPorOrden $orden)
    {
